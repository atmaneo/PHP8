...
// on va définir des constantes d'environnement qui vont contenir les informat de connexion à ma BDD
    define("DBHOST","localhost");    // c avec define qu'on crée des constantes. la variable DBHOST sera mon serveur (localhost)
...
// ici le dsn est affecté à la variable $dsn
...
// essaye de faire ce kil y a ds try et sinon gère le en faisant ce kil y a dans catch; 
    try{    
        ...
        $db->exec("SET NAMES utf8");            // execute moi la req sql qui s'appelle SET_NAMES. c 1 req sql qui dit attent tt les échanges entre mon php et ma BDD vont se faire en uft8
